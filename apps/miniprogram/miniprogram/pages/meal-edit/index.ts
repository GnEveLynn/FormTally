...
Page({
  ...
  type(event: { detail: { value: string } }) { this.setData({ mealType: ['breakfast', 'lunch', 'dinner', 'snack'][Number(event.detail.value)] ?? 'lunch' }) },
